...
### VARAIBLES ###
SPIGOT_USR_PASS=SPIG_supe01!
MYSQL_DATABASE_PASS=MYSQ_supe01!
SHH_PORT_OLD=22
SSH_PORT_NEW=22366
SERVER_VERSION=1.17
WEB_DOMAIN=supernawesome.com

# Add user for server
useradd spigot
chpasswd spigot:$SPIGOT_USR_PASS
...
mkdir /home/spigot/server/plugins
...
# Scripts directory
mkdir /home/spigot/scripts

# Backup direcctories
mkdir /home/spigot/backups
mkdir /home/spigot/backups/live

# Overviewer
mkdir /home/spigot/overviewer
...
touch /etc/apache2/sites-available/${WEB_DOMAIN}.conf
{
    ...
    echo "    ServerAlias www.${WEB_DOMAIN}"
    echo "    ServerAdmin webmaster@${WEB_DOMAIN}"
    echo "    DocumentRoot /var/www/${WEB_DOMAIN}/public_html"

    echo "    <Directory /var/www/${WEB_DOMAIN}/public_html>"
    echo "        Options -Indexes +FollowSymLinks"
    echo "        AllowOverride All"
    echo "    </Directory>"

    echo "    ErrorLog ${APACHE_LOG_DIR}/${WEB_DOMAIN}-error.log"
    echo "    CustomLog ${APACHE_LOG_DIR}/${WEB_DOMAIN}-access.log combined"
    echo "</VirtualHost>"
} >> /etc/apache2/sites-available/${WEB_DOMAIN}.conf
